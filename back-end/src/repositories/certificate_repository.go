...
type CertificateRepository interface {
	...
	ListWithStudent() ([]models.Certificate, error)
...
func (r *GormCertificateRepository) ListWithStudent() ([]models.Certificate, error) {
	var certs []models.Certificate
	if err := r.db.Preload("Student").Order("created_at DESC").Find(&certs).Error; err != nil {
		return nil, err
	}
	return certs, nil
}
